...
**Atheer Switch Backend** هو المحرك المركزي (Payment Switch) الذي يعالج ويتحقق من معاملات الدفع القادمة من [Atheer SDK]([../sdk/README.md](https://github.com/ahmedaliahmed775/atheer-sdk)). يعمل كبوابة ذكية بين تطبيقات التجار والمحافظ الإلكترونية اليمنية.
